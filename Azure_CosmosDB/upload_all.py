...
def upload_to_container(container, new_pos, max_defs, plots_defs, plots_cracks, plots_s, str_bot, str_top):
...
upload_to_container(container, new_pos, max_defs, plots_defs,
                    plots_cracks, plots_s, str_bot, str_top)
